...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToScreen()
        PanelRegistrationalEditUserData.Visible = False
    ...
    Private Sub ShowData()
        ...
        Try
            If LoadImagesStr = False Then
                ...
                MySQLCMD.CommandType = "SELECT Name, ID, Address, City, Country FROM " & Table_Name & "ORDER BY Name"
            ...
            Else
                ...
                If Data > 0 Then
                    ...
                    PictureBoxUserImage.BackgroundImage = Image.FromStream(ImgStr)
                    ImgStr.Close()
    ...
    Private Sub ClearInputUpdateData()
        ...
        TextBoxCity.Text = ""
        TextBoxCountry.Text = ""
        PictureBoxImageInput.Image = My.Resources._111111
    End Sub
    Private Sub ButtonConnection_Click(sender As Object, e As EventArgs) Handles ButtonConection.Click
        PictureBoxSelect.Top = ButtonConection.Top
        PanelUserData.Visible = False
        PanelRegistrationalEditUserData.Visible = False
        PanelConnection.Visible = True
    End Sub
    ...
    Private Sub ButtonRegistration_Click(sender As Object, e As EventArgs) Handles ButtonRegistration.Click
        ...
        PanelConnection.Visible = False
        PanelUserData.Visible = False
        PanelRegistrationalEditUserData.Visible = True
        ShowData()
    End Sub
    ...
    End Sub
    Private Sub PanelRegistrationalEditUserData_Paint(sender As Object, e As PaintEventArgs) Handles PanelConnection.Paint
        e.Graphics.DrawRectangle(New Pen(Color.LightGray, 2), PanelConnection.ClientRectangle)

    End Sub
    Private Sub PanelUserData_Paint(sender As Object, e As PaintEventArgs) Handles PanelConnection.Paint
        e.Graphics.DrawRectangle(New Pen(Color.LightGray, 2), PanelConnection.ClientRectangle)
    ...
    Private Sub PanelRegistrationandEditUserData_Resize(sender As Object, e As EventArgs) Handles PanelRegistrationalEditUserData.Resize
        PanelRegistrationalEditUserData.Invalidate()
    End Sub
    ...
    Private Sub ButtonConnect_Click(sender As Object, e As EventArgs) Handles ButtonConnect.Click
        If ButtonConnect.Text = "Connect" Then
            ...
            Try
                ...
                PictureBoxStatusConnect.BackgroundImage = My.Resources._1123
            Catch ex As Exception
    ...
    Private Sub ButtonConnect_MouseLeave(sender As Object, e As EventArgs) Handles ButtonConnect.MouseLeave, ButtonScanPort.MouseLeave
        ButtonConnect.ForeColor = Color.FromArgb(6, 71, 165)
    End Sub

    Private Sub ButtonClear_Click(sender As Object, e As EventArgs) Handles ButtonClear.Click
        LabelID.Text = "ID : _______"
        LabelName.Text = "Waiting..."
        LabelAddress.Text = "Waiting..."
        LabelCity.Text = "Waiting..."
        LabelCountry.Text = "Waiting..."
        PictureBoxUserImage.BackgroundImage = Nothing
    End Sub
    ...
    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            StatusInput = "Save"
        End If
        PictureBoxImagePreview.BackgroundImage = Nothing
        ShowData()
    End Sub
    ...
    Private Function ING_FileNameInput() As String
        Throw New NotImplementedException()
    End Function

    Private Sub CheckBoxByName_CheckedChange(sender As Object, e As EventArgs) Handles CheckBoxByName.CheckedChanged
    ...
    Private Sub CheckBoxByID_CheckedChange(sender As Object, e As EventArgs) Handles CheckBoxByID.CheckedChanged
    ...
    Private Sub SelectAllToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelectedAllToolStripMenuItem.Click
        DataGridView1.SelectAll()
    End Sub

    Private Sub ClearSelectAllToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ClearSelectionToolStripMenuItem.Click
        DataGridView1.ClearSelection()
        PictureBoxImagePreview.BackgroundImage = Nothing
    End Sub

    Private Sub RefreshToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles RefreshToolStripMenuItem.Click
        ShowData()
    End Sub
    ...
    Private Sub TimerSerialIn_Tick(sender As Object, e As EventArgs) Handles TimerSerialIn.Tick
        Try
            ...
            If StrSerialIn <> "" Then
                If GetID = True Then
                    ...
                    GetID = False
                    If LabelGetID.Text <> "__________" Then
        ...
        Catch ex As Exception
            TimerSerialIn.Stop()
            SerialPort1.Close()
            LabelConectionStatus.Text = "Connection Status : Disconnected"
            PictureBoxStatusConnect.BackgroundImage = My.Resources._1123
            MsgBox("Failed to connect !!!" & vbCr & "Arduino is not detected.", MsgBoxStyle.Critical, "Error Message")
    ...
    Private Sub ViewData()
        ...
        If LabelID.Text = "ID : __________" Then
            ViewData()
        Else
            ShowData()
        End If
    ...
    Private Sub Form1_Resize(sender As Object, e As EventArgs) Handles Me.Resize
        ...
        PanelReadingTagProcess.Location = New Point((PanelRegistrationalEditUserData.Width / 2) - (PanelReadingTagProcess.Width / 2), 106)
    End Sub

    Private Sub ButtonCloseReadingTag_Click(sender As Object, e As EventArgs) Handles ButtonCloseReading.Click
        PanelReadingTagProcess.Visible = False
        ButtonScanID.Enabled = True
    End Sub
    ...
    Private Sub PictureBoxImageInput_Click_1(sender As Object, e As EventArgs) Handles PictureBoxImageInput.Click
